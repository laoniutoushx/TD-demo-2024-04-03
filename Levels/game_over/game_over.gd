...
func setup(is_win: bool) -> void:
    ...
    %WaveLabel.text = "完成波次：%d/%d" % [SOS.main.level_controller._cur_scene.wave_manager.cur_wave_index, SOS.main.level_controller._cur_scene.wave_manager.wave_resources.size()]
...
func _on_restart_pressed() -> void:
    SOS.main.level_controller.next_level("index")
