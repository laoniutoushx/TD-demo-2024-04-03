...
var choose_player_shader = preload("res://Levels/choose_player/ChoosePlayer.gdshader")
...
func _input(event: InputEvent) -> void:
	if event is InputEventMouseButton and event.button_index == MOUSE_BUTTON_LEFT and not event.pressed and _on_mouse_choose:
